...
from ...models.fire_action_default_single_part_system_action import FireActionDefaultSinglePartSystemAction
...
def _get_kwargs(
    system_action: FireActionDefaultSinglePartSystemAction,
    *,
    client: Client,
