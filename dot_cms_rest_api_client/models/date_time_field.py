...
class DateTimeField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, DateTimeFieldDataType]):
    """
    ...
    data_type: Union[Unset, DateTimeFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = DateTimeFieldDataType(_data_type)
        ...
        date_time_field.additional_properties = d
