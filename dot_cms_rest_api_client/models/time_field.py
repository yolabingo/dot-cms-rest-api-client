...
from ..models.time_field_data_type import TimeFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeField")
...
class TimeField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, TimeFieldDataType]):
    """
    ...
    data_type: Union[Unset, TimeFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = TimeFieldDataType(_data_type)
        ...
        time_field.additional_properties = d
        return time_field
