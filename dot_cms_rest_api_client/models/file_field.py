...
from ..models.file_field_data_type import FileFieldDataType
...
class FileField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, FileFieldDataType]):
    """
    ...
    data_type: Union[Unset, FileFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = FileFieldDataType(_data_type)
