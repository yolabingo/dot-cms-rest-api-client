...
from ..models.tab_divider_field_data_type import TabDividerFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TabDividerField")
...
class TabDividerField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, TabDividerFieldDataType]):
    """
    ...
    data_type: Union[Unset, TabDividerFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = TabDividerFieldDataType(_data_type)

        tab_divider_field = cls(
            clazz=clazz,
        ...
        tab_divider_field.additional_properties = d
        return tab_divider_field
