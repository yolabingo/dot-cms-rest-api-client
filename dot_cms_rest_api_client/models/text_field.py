...
from ..models.text_field_data_type import TextFieldDataType
...
class TextField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, TextFieldDataType]):
    """
    ...
    data_type: Union[Unset, TextFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = TextFieldDataType(_data_type)
