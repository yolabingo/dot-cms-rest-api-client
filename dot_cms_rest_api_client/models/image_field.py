...
from ..models.image_field_data_type import ImageFieldDataType
...
class ImageField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, ImageFieldDataType]):
    """
    ...
    data_type: Union[Unset, ImageFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = ImageFieldDataType(_data_type)
