...
from ..models.line_divider_field_data_type import LineDividerFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="LineDividerField")
...
class LineDividerField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, LineDividerFieldDataType]):
    """
    ...
    data_type: Union[Unset, LineDividerFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = LineDividerFieldDataType(_data_type)

        line_divider_field = cls(
            clazz=clazz,
        ...
        line_divider_field.additional_properties = d
        return line_divider_field
