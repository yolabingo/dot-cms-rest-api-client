...
from ..models.hidden_field_data_type import HiddenFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="HiddenField")
...
class HiddenField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, HiddenFieldDataType]):
    """
    ...
    data_type: Union[Unset, HiddenFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = HiddenFieldDataType(_data_type)
        ...
        hidden_field.additional_properties = d
        return hidden_field
