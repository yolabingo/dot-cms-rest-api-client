...
from ..models.date_field_data_type import DateFieldDataType
...
class DateField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, DateFieldDataType]):
    """
    ...
    data_type: Union[Unset, DateFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = DateFieldDataType(_data_type)
        ...
        date_field.additional_properties = d
        return date_field
