...
from ..models.row_field_data_type import RowFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RowField")
...
class RowField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, RowFieldDataType]):
    """
    ...
    data_type: Union[Unset, RowFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = RowFieldDataType(_data_type)
        ...
        row_field.additional_properties = d
        return row_field
