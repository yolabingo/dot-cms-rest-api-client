...
from ..models.tag_field_data_type import TagFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TagField")
...
class TagField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, TagFieldDataType]):
    """
    ...
    data_type: Union[Unset, TagFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = TagFieldDataType(_data_type)
        ...
        tag_field.additional_properties = d
        return tag_field
