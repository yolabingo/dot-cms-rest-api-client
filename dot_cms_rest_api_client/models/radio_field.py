...
from ..models.radio_field_data_type import RadioFieldDataType
...
class RadioField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, RadioFieldDataType]):
    """
    ...
    data_type: Union[Unset, RadioFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = RadioFieldDataType(_data_type)
