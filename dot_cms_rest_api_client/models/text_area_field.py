...
from ..models.text_area_field_data_type import TextAreaFieldDataType
...
class TextAreaField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, TextAreaFieldDataType]):
    """
    ...
    data_type: Union[Unset, TextAreaFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = TextAreaFieldDataType(_data_type)
        ...
        text_area_field.additional_properties = d
