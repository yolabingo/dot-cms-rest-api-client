...
class BinaryField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, BinaryFieldDataType]):
    """
    ...
    data_type: Union[Unset, BinaryFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = BinaryFieldDataType(_data_type)
        ...
        binary_field.additional_properties = d
        return binary_field
