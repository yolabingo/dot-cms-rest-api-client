...
from ..models.checkbox_field_data_type import CheckboxFieldDataType
...
class CheckboxField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, CheckboxFieldDataType]):
    """
    ...
    data_type: Union[Unset, CheckboxFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = CheckboxFieldDataType(_data_type)
