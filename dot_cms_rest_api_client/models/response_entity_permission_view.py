...
from ..models.permission_view import PermissionView
from ..models.response_entity_permission_view_i18n_messages_map import ResponseEntityPermissionViewI18NMessagesMap
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResponseEntityPermissionView")
...
class ResponseEntityPermissionView:
    ...
    Attributes:
        ...
        entity (Union[Unset, List[PermissionView]]):
        messages (Union[Unset, List[MessageEntity]]):
        i_18_n_messages_map (Union[Unset, ResponseEntityPermissionViewI18NMessagesMap]):
        permissions (Union[Unset, List[str]]):
    """

    errors: Union[Unset, List[ErrorEntity]] = UNSET
    entity: Union[Unset, List[PermissionView]] = UNSET
    messages: Union[Unset, List[MessageEntity]] = UNSET
    i_18_n_messages_map: Union[Unset, ResponseEntityPermissionViewI18NMessagesMap] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for entity_item_data in _entity or []:
            entity_item = PermissionView.from_dict(entity_item_data)
        ...
        if isinstance(_i_18_n_messages_map, Unset):
            ...
            i_18_n_messages_map = ResponseEntityPermissionViewI18NMessagesMap.from_dict(_i_18_n_messages_map)

        permissions = cast(List[str], d.pop("permissions", UNSET))

        response_entity_permission_view = cls(
            errors=errors,
            entity=entity,
            messages=messages,
        ...
        response_entity_permission_view.additional_properties = d
        return response_entity_permission_view
