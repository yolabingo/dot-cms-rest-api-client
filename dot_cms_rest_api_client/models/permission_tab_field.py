...
from ..models.permission_tab_field_data_type import PermissionTabFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PermissionTabField")
...
class PermissionTabField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, PermissionTabFieldDataType]):
    """
    ...
    data_type: Union[Unset, PermissionTabFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = PermissionTabFieldDataType(_data_type)

        permission_tab_field = cls(
            clazz=clazz,
        ...
        permission_tab_field.additional_properties = d
        return permission_tab_field
