...
from ..models.fire_action_form_contentlet import FireActionFormContentlet
from ..models.fire_action_form_individual_permissions import FireActionFormIndividualPermissions
from ..types import UNSET, Unset

T = TypeVar("T", bound="FireActionForm")
...
class FireActionForm:
    ...
    Attributes:
        ...
        individual_permissions (Union[Unset, FireActionFormIndividualPermissions]):
        iwant_to (Union[Unset, str]):
        contentlet (Union[Unset, FireActionFormContentlet]):
    """
    ...
    individual_permissions: Union[Unset, FireActionFormIndividualPermissions] = UNSET
    iwant_to: Union[Unset, str] = UNSET
    contentlet: Union[Unset, FireActionFormContentlet] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_individual_permissions, Unset):
            ...
            individual_permissions = FireActionFormIndividualPermissions.from_dict(_individual_permissions)
        ...
        if isinstance(_contentlet, Unset):
            ...
            contentlet = FireActionFormContentlet.from_dict(_contentlet)

        fire_action_form = cls(
            comments=comments,
            assign=assign,
        ...
        fire_action_form.additional_properties = d
        return fire_action_form
