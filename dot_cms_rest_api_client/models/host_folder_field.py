...
from ..models.host_folder_field_data_type import HostFolderFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="HostFolderField")
...
class HostFolderField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, HostFolderFieldDataType]):
    """
    ...
    data_type: Union[Unset, HostFolderFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = HostFolderFieldDataType(_data_type)

        host_folder_field = cls(
            clazz=clazz,
        ...
        host_folder_field.additional_properties = d
        return host_folder_field
