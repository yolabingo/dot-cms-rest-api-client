...
T = TypeVar("T", bound="DeleteBundlesByIdentifierForm")
...
class DeleteBundlesByIdentifierForm:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_bundles_by_identifier_form = cls(
            identifiers=identifiers,
        )

        delete_bundles_by_identifier_form.additional_properties = d
        return delete_bundles_by_identifier_form
