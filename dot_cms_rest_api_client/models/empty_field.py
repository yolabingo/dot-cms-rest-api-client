...
class EmptyField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, EmptyFieldDataType]):
    """
    ...
    data_type: Union[Unset, EmptyFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = EmptyFieldDataType(_data_type)
        ...
        empty_field.additional_properties = d
        return empty_field
