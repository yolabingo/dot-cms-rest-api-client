...
class ConstantField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, ConstantFieldDataType]):
    """
    ...
    data_type: Union[Unset, ConstantFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = ConstantFieldDataType(_data_type)
        ...
        constant_field.additional_properties = d
