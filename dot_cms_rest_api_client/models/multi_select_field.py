...
from ..models.multi_select_field_data_type import MultiSelectFieldDataType
...
class MultiSelectField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, MultiSelectFieldDataType]):
    """
    ...
    data_type: Union[Unset, MultiSelectFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = MultiSelectFieldDataType(_data_type)
