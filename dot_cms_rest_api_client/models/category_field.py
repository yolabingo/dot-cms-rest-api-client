...
class CategoryField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, CategoryFieldDataType]):
    """
    ...
    data_type: Union[Unset, CategoryFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = CategoryFieldDataType(_data_type)
        ...
        category_field.additional_properties = d
