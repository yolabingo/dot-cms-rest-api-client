...
from ..models.wysiwyg_field_data_type import WysiwygFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WysiwygField")
...
class WysiwygField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, WysiwygFieldDataType]):
    """
    ...
    data_type: Union[Unset, WysiwygFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = WysiwygFieldDataType(_data_type)
        ...
        wysiwyg_field.additional_properties = d
        return wysiwyg_field
