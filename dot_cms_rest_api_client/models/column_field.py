...
class ColumnField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, ColumnFieldDataType]):
    """
    ...
    data_type: Union[Unset, ColumnFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = ColumnFieldDataType(_data_type)
        ...
        column_field.additional_properties = d
        return column_field
