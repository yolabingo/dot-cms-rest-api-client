...
from ..models.key_value_field_data_type import KeyValueFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="KeyValueField")
...
class KeyValueField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, KeyValueFieldDataType]):
    """
    ...
    data_type: Union[Unset, KeyValueFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = KeyValueFieldDataType(_data_type)
        ...
        key_value_field.additional_properties = d
