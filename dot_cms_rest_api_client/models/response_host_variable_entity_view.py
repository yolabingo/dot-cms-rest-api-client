...
from ..models.host_variable import HostVariable
from ..models.message_entity import MessageEntity
from ..models.response_host_variable_entity_view_i18n_messages_map import ResponseHostVariableEntityViewI18NMessagesMap
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResponseHostVariableEntityView")
...
class ResponseHostVariableEntityView:
    ...
    Attributes:
        ...
        entity (Union[Unset, HostVariable]):
        messages (Union[Unset, List[MessageEntity]]):
        i_18_n_messages_map (Union[Unset, ResponseHostVariableEntityViewI18NMessagesMap]):
        permissions (Union[Unset, List[str]]):
    """

    errors: Union[Unset, List[ErrorEntity]] = UNSET
    entity: Union[Unset, HostVariable] = UNSET
    messages: Union[Unset, List[MessageEntity]] = UNSET
    i_18_n_messages_map: Union[Unset, ResponseHostVariableEntityViewI18NMessagesMap] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_entity, Unset):
            ...
            entity = HostVariable.from_dict(_entity)
        ...
        if isinstance(_i_18_n_messages_map, Unset):
            ...
            i_18_n_messages_map = ResponseHostVariableEntityViewI18NMessagesMap.from_dict(_i_18_n_messages_map)

        permissions = cast(List[str], d.pop("permissions", UNSET))

        response_host_variable_entity_view = cls(
            errors=errors,
            entity=entity,
            messages=messages,
        ...
        response_host_variable_entity_view.additional_properties = d
        return response_host_variable_entity_view
