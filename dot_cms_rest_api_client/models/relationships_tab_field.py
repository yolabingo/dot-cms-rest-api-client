...
from ..models.relationships_tab_field_data_type import RelationshipsTabFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RelationshipsTabField")
...
class RelationshipsTabField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, RelationshipsTabFieldDataType]):
    """
    ...
    data_type: Union[Unset, RelationshipsTabFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = RelationshipsTabFieldDataType(_data_type)

        relationships_tab_field = cls(
            clazz=clazz,
        ...
        relationships_tab_field.additional_properties = d
        return relationships_tab_field
