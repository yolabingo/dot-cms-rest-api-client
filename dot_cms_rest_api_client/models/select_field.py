...
from ..models.select_field_data_type import SelectFieldDataType
...
class SelectField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, SelectFieldDataType]):
    """
    ...
    data_type: Union[Unset, SelectFieldDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = SelectFieldDataType(_data_type)
