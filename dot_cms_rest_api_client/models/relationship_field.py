...
from ..models.relationship_field_data_type import RelationshipFieldDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RelationshipField")
...
class RelationshipField:
    ...
    Attributes:
        ...
        data_type (Union[Unset, RelationshipFieldDataType]):
        skip_relationship_creation (Union[Unset, bool]):
    """
    ...
    data_type: Union[Unset, RelationshipFieldDataType] = UNSET
    skip_relationship_creation: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        skip_relationship_creation = self.skip_relationship_creation
        ...
        if skip_relationship_creation is not UNSET:
            field_dict["skipRelationshipCreation"] = skip_relationship_creation
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_type, Unset):
            ...
            data_type = RelationshipFieldDataType(_data_type)

        skip_relationship_creation = d.pop("skipRelationshipCreation", UNSET)

        relationship_field = cls(
            clazz=clazz,
            ...
            indexed=indexed,
            data_type=data_type,
            skip_relationship_creation=skip_relationship_creation,
        )

        relationship_field.additional_properties = d
